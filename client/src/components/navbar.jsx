            ...
            <div class="relative mx-auto max-w-7xl w-full">
                <div class="flex relative px-8 flex-col lg:px-32 md:flex-row md:items-center md:justify-between md:px-12 mx-auto py-4 w-full" x-data="{ open: false }">
                    ...
                    <nav class="items-center flex-col flex-grow hidden md:flex md:flex-row md:justify-end md:pb-0" >
                        ...
                        <Link href="/blog" class="text-sm text-white font-normal hover:text-white/50 lg:px-6 md:px-3 px-2 py-2">Blog</Link>
                        <Link href="/generation-examples" class="text-sm text-white font-normal hover:text-white/50 lg:px-6 md:px-3 px-2 py-2">Generation Examples</Link>
                        <Link href="/zapier-integration" class="text-sm text-white font-normal hover:text-white/50 lg:px-6 md:px-3 px-2 py-2">Zapier</Link>
                        <Link href="/bootstrap-to-tailwindcss-code-converter" class="text-sm text-white font-normal hover:text-white/50 lg:px-6 md:px-3 px-2 py-2">Free tools</Link>
                        <Link href="https://app.docuwriter.ai/login" class="items-center relative text-sm bg-gradient-to-br dark:focus:ring-lime-800 dark:hover:text-gray-900 dark:text-white focus:outline-none focus:ring-4 focus:ring-lime-200 font-medium from-green-400 group group-hover:from-green-400 group-hover:to-lime-500 inline-flex justify-center overflow-hidden p-0.5 rounded-lg text-gray-900 to-lime-500 lg:ml-auto">
